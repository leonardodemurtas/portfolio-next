                                ...
                                <CarouselItem key={index} className="pl-6 basis-full">
                                     <div className="relative h-fit overflow-hidden w-full group rounded-2xl border border-[#D0D0D0]">
                                        ...
                                        <div className="absolute bottom-10 left-10 z-20">
                                            <span className="inline-block px-5 py-2.5 bg-[rgba(255,255,255,0.12)] backdrop-blur-[12px] text-white text-lg font-medium rounded-full border border-[rgba(230,229,229,0.30)] shadow-lg">
                                                {slide.title}
                                            </span>
                                        </div>
                                    </div>
