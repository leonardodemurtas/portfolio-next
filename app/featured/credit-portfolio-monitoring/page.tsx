...
import { GuidedTourTrigger } from "../../components/guided-tour/GuidedTourTrigger";
            ...
            <section className="bg-[var(--background)] py-14 px-6">
                <div className="flex flex-col md:flex-row gap-8 justify-center max-w-[1200px] mx-auto">
                    ...
                    >
                        ...
                        <div className="pt-8">
                            <GuidedTourTrigger
                                tourId="cpm_journeyMap"
                                className="bg-neutral-900 text-neutral-50 px-6 py-3 rounded-full text-lg flex items-center gap-2"
                            >
